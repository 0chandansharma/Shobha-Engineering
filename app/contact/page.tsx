          ...
          <div className="contact-layout">
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 32 }}>
                <a href="https://wa.me/919415154200?text=Hello%2C%20I%20would%20like%20to%20get%20a%20quote%20from%20Shobha%20Engineering%20Workshop."
                  target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#25D366', color: '#fff', padding: '10px 18px', borderRadius: 6, fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>
                ...
                <a href="https://www.linkedin.com/company/shobhaengineeringworkshop/" target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#0A66C2', color: '#fff', padding: '10px 18px', borderRadius: 6, fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>
                ...
                <a href="https://www.facebook.com/people/Shobha-Engineering-Workshop/61590253234646/" target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#1877F2', color: '#fff', padding: '10px 18px', borderRadius: 6, fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>
                ...
                <a href="https://www.indiamart.com/shobha-engg-workshop/" target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#ef7f1a', color: '#fff', padding: '10px 18px', borderRadius: 6, fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>
